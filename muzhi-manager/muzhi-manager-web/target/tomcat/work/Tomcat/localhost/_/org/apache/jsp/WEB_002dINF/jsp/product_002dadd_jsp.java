 ...
 * Generated at: 2018-10-10 01:21:19 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t<form action=\"\" method=\"post\" class=\"form form-horizontal\" id=\"form-article-add\">\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\"><span class=\"c-red\">*</span>商品名称：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"input-text\" value=\"\" placeholder=\"请输入您的商品名称\" id=\"tb_order_name\" name=\"tb_order_name\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!--<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">简略标题：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"input-text\" value=\"\" placeholder=\"\" id=\"\" name=\"\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\"><span class=\"c-red\">*</span>商品一级分类：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\"> <span class=\"select-box\">\r\n");
      out.write("\t\t\t\t<select name=\"tb_order_yiji\" class=\"select\">\r\n");
      out.write("\t\t\t\t\t<option value=\"0\">服饰</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"1\">画</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"11\">饰品</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"12\">陶瓷</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"13\">雕塑</option>\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</span> </div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\"><span class=\"c-red\">*</span>商品二级分类：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\"> <span class=\"select-box\">\r\n");
      out.write("\t\t\t\t<select name=\"tb_order_yiji\" class=\"select\">\r\n");
      out.write("\t\t\t\t\t<option value=\"0\">汉服</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"1\">唐装</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"11\">和服</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"12\">旗袍</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"13\">其他</option>\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</span> </div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!--<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">排序值：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"input-text\" value=\"0\" placeholder=\"\" id=\"\" name=\"\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">是否打折：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9 skin-minimal\">\r\n");
      out.write("\t\t\t\t<div class=\"check-box\">\r\n");
      out.write("\t\t\t\t\t<input type=\"checkbox\" id=\"tb_order_discount\">\r\n");
      out.write("\t\t\t\t\t<label for=\"tb_order_discount\">&nbsp;</label>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("<!--\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品规格：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"输入长度\" value=\"\" class=\"input-text\" style=\" width:25%\">\r\n");
      out.write("\t\t\t\tMM\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"输入宽度\" value=\"\" class=\"input-text\" style=\" width:25%\">\r\n");
      out.write("\t\t\t\tMM\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"输入高度\" value=\"\" class=\"input-text\" style=\" width:25%\">\r\n");
      out.write("\t\t\t\tMM </div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("<!--\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">商品定价：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"\" value=\"\" class=\"input-text\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">商品库存：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=tb_order_stock\"\" id=\"tb_order_stock\" placeholder=\"请输入商品的库存\" value=\"\" class=\"input-text\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!--<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">所属供应商：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"\" value=\"\" class=\"input-text\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">价格计算单位：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\"> <span class=\"select-box\">\r\n");
      out.write("\t\t\t\t<select class=\"select\">\r\n");
      out.write("\t\t\t\t\t<option>请选择</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"1\">件</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"2\">斤</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"3\">KG</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"4\">吨</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"5\">套</option>\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</span> </div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("<!--\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品重量：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"\" value=\"\" class=\"input-text\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\tkg</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品展示价格：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"tb_order_presentPrice\" id=\"tb_order_presentPrice\" placeholder=\"请输入商品售价\" value=\"\" class=\"input-text\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\t元</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">原格：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"tb_order_originalPrice\" id=\"tb_order_originalPrice\" placeholder=\"请输入商品原价\" value=\"\" class=\"input-text\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\t元</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t<!--\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">成本价格：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"\" value=\"\" class=\"input-text\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\t元</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t<!--\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">最低销售价格：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"\" value=\"\" class=\"input-text\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\t元</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品上架时间：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" onfocus=\"WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\\'datemax\\')||\\'%y-%M-%d\\'}' })\" id=\"tb_order_created\" name=\"tb_order_created\" class=\"input-text Wdate\" style=\"width:180px;\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品更新时间：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" onfocus=\"WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\\'datemin\\')}' })\" id=\"tb_order_updated\"  name=\"tb_order_updated\" class=\"input-text Wdate\" style=\"width:180px;\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("<!--\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品关键字：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"\" id=\"\" placeholder=\"多个关键字用英文逗号隔开，限10个关键字\" value=\"\" class=\"input-text\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("<!--\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">产品摘要：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<textarea name=\"tb_order\" cols=\"\" rows=\"\" class=\"textarea\"  placeholder=\"输入商品简介\" datatype=\"*10-100\" dragonfly=\"true\" nullmsg=\"备注不能为空！\" onKeyUp=\"$.Huitextarealength(this,200)\"></textarea>\r\n");
      out.write("\t\t\t\t<p class=\"textarea-numberbar\"><em class=\"textarea-length\">0</em>/200</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>-->\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">缩略图：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<div class=\"uploader-thum-container\">\r\n");
      out.write("\t\t\t\t\t<div id=\"fileList\" class=\"uploader-list\"></div>\r\n");
      out.write("\t\t\t\t\t<div id=\"filePicker\">选择图片</div>\r\n");
      out.write("\t\t\t\t\t<button id=\"btn-star\" class=\"btn btn-default btn-uploadstar radius ml-10\">开始上传</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">图片上传：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("\t\t\t\t<div class=\"uploader-list-container\">\r\n");
      out.write("\t\t\t\t\t<div class=\"queueList\">\r\n");
      out.write("\t\t\t\t\t\t<div id=\"dndArea\" class=\"placeholder\">\r\n");
      out.write("\t\t\t\t\t\t\t<div id=\"filePicker-2\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t<p>或将照片拖到这里，单次最多可选5张</p>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      out.write("\t\t\t<label class=\"form-label col-xs-4 col-sm-2\">详细内容：</label>\r\n");
      out.write("\t\t\t<div class=\"formControls col-xs-8 col-sm-9\"> \r\n");
      out.write("\t\t\t\t<script id=\"editor\" type=\"text/plain\" style=\"width:100%;height:400px;\"></script> \r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"row cl\">\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"/lib/ueditor/1.4.3/ueditor.config.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\" src=\"/lib/ueditor/1.4.3/ueditor.all.min.js\"> </script>\r\n");
      out.write("<script type=\"text/javascript\" src=\"/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js\"></script>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\t// 文件接收服务端。\r\n");
      out.write("\t\tserver: '/lib/webuploader/0.1.5/server/fileupload.php',\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tvar $li = $(\r\n");
      out.write("\t\t\t'<div id=\"' + file.id + '\" class=\"item\">' +\r\n");
      out.write("\t\t\t\t'<div class=\"pic-box\"><img></div>'+\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\t// 创建缩略图\r\n");
      out.write("\t\t// 如果为非图片文件，可以不用调用此方法。\r\n");
      out.write("\t\t// thumbnailWidth x thumbnailHeight 为 100 x 100\r\n");
      ...
      out.write("\t\t\t$percent = $li.find('.progress-box .sr-only');\r\n");
      out.write("\t\r\n");
      out.write("\t\t// 避免重复创建\r\n");
      out.write("\t\tif ( !$percent.length ) {\r\n");
      out.write("\t\t\t$percent = $('<div class=\"progress-box\"><span class=\"progress-bar radius\"><span class=\"sr-only\" style=\"width:0%\"></span></span></div>').appendTo( $li ).find('.sr-only');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$li.find(\".state\").text(\"上传中\");\r\n");
      ...
      out.write("\t\t$( '#'+file.id ).addClass('upload-state-success').find(\".state\").text(\"已上传\");\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t// 文件上传失败，显示上传出错。\r\n");
      out.write("\tuploader.on( 'uploadError', function( file ) {\r\n");
      out.write("\t\t$( '#'+file.id ).addClass('upload-state-error').find(\".state\").text(\"上传出错\");\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t// 完成上传完了，成功或者失败，先删除进度条。\r\n");
      out.write("\tuploader.on( 'uploadComplete', function( file ) {\r\n");
      out.write("\t\t$( '#'+file.id ).find('.progress-box').fadeOut();\r\n");
      out.write("\t});\r\n");
